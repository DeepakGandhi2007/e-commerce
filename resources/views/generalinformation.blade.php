            ...
            <main id="mt-main">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-9 wow fadeInRight" style="border: 1px solid black" data-wow-delay="0.4s">
                            ...
                            <form action="{{ url('edit_info') }}" method="post"
                                ...
                                @csrf
                                        <div class="bg-light rounded h-100 p-4">
                                            <h2 class="mb-4" style="border-bottom: 1px dotted black">order</h2>
                                            @foreach ($order_data as $data)
                                            <div class="col-md-9" style="box-shadow:1px 1px 1px 1px #202020; width:100%">
                                             <b style="font-size:18px;margin-right:321px">Order Id:{{$data->order_id }}</b>
                                             <div class="col-md-6" style="border-right:2px solid black;width:450px">
                                             <p style="margin-top: 15px">Order Date:<span style="margin-left:250px">{{$data->created_at }}</span></p>
                                             <p style="margin-top: 40px">Cart Subtotal:<span  style="margin-left:250px">{{$data->cart_subtotal }}<a style="margin-left:560px" href="{{url('orderdetail/' . $data->id)}}" class="btn btn-primary">View Order</a></span></p>
                                             <p style="margin-top: 15px">Total Amount:<span  style="margin-left:250px">{{$data->total_amount }}</span></p>

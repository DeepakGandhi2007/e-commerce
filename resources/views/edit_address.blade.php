                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-9 wow fadeInRight" data-wow-delay="0.4s">
                            ...
                            @endif
                            <form action="{{ url('edit_shipping_add') }}" style="margin-left:250" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            @foreach ($address_data as $data)
                            <?php $unserr=unserialize($data->shipping_address);?>
                                        <div class="bg-light rounded h-100 p-4" style="border: solid 1px black;padding:20px">
                                            ...
                                            <div class="form-floating mb-3" style="margin-top:40px">
                                                ...
                                                <input  type="text" name="shippinadd" class="form-control"
                                           ...
                                           <div class="form-floating mb-3" style="margin-top:20px">
                                            <label for="floatingInput">Flat</label>
                                                    <input type="text" name="shippingflat" class="form-control"
                                                        id="floatingInput" placeholder="Catgeory Name"
                                                ...
                                                <div class="form-floating mb-3" style="margin-top:20px">
                                                    ...
                                                    <input type="text" name="shippngland" class="form-control"
                                                        id="floatingInput" placeholder="Catgeory Name"
                                                ...
                                                <div class="form-floating mb-3" style="margin-top:20px">
                                                    ...
                                                    <input type="text" name="shippingzip" class="form-control"
                                                        id="floatingInput" placeholder="Catgeory Name"

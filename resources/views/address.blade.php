            ...
            <main id="mt-main">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-9 wow fadeInRight" style="border: 1px solid black;padding-bottom: 20px;" data-wow-delay="0.4s">
                            <h2 class="mb-4" style="border-bottom: 1px dotted black">Account Details</h2>
                            @foreach ($address_data as $datas)
                            <?php $shipping = $datas->shipping_address; ?>
                            <?php $unserr = unserialize($datas->shipping_address); ?>
                          @endforeach
                            @foreach ($address_data as $datas)
                                <?php $shipping = $datas->shipping_address; ?>
                                <?php $unserr = unserialize($datas->shipping_address); ?>
                                @if (isset($unserr['address']))
                                <div
                                style=" background-color: lightgray; !important;padding:  10px;margin-top: 25px;margin-left:10px;width:95%;margin-right:25px">
                                <a href="{{ url('edit_address/' . $datas->id) }}" style="cursor:pointer;float: right;"
                                    class="btn btn-primary">edit</a>
                                     <strong
                                    style="  color:black ;font-size: 15PX;"> Address:</strong> <span
                                    style=" color:   black;padding:5px;text-transform:  uppercase ;"><?php print_r($unserr['address']); ?></span><br><strong
                                    style="  color:black ;font-size: 15PX;"> flat:</strong> <span
                                    style=" color: black  ;padding:5px;text-transform:  uppercase ;"><?php print_r($unserr['flat']); ?></span><br><strong
                                    style="  color:black ;font-size: 15PX;"> state:</strong> <span
                                    style=" color: black  ;padding:5px;text-transform:  uppercase ;"><?php print_r($unserr['state']); ?></span><br>
                                <span style=" color: black  ;padding:5px;text-transform:  uppercase ;"> <i
                                        type="button"
                                        style="cursor:pointer;font-size: 20px;color: red;float:right;margin-right:15px"
                                        name="delete" id="" class='fa fa-trash delete'></i></span>
                            </div>
                                @endif
                                @endforeach

                    ...
                    <div class="mt-side-widget">
                      ...
                      <form method="POST" action="{{ route('login') }}">
                        ...
                        <fieldset>
                            ...
                            @enderror
                          <div class="box">
                            <span class="left"><input class="checkbox" type="checkbox" id="remember" {{ old('remember') ? 'checked' : '' }}><label for="check1">Remember Me</label></span>
                      ...
                      <a href="{{ url('auth/regsiter') }}"> dont have account ?? signup</a>
                          <button type="submit" class="btn-type1">     {{ __('Login') }}</button>
                        </fieldset>
                      </form>
                    </div>
                </div>
